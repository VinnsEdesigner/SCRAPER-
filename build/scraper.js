"use strict";(()=>{var $t=Object.defineProperty;var v=(e,t)=>()=>(e&&(t=e(e=0)),t);var z=(e,t)=>{for(var n in t)$t(e,n,{get:t[n],enumerable:!0})};var R={};z(R,{addSnippet:()=>G,clearSnippets:()=>M,getSessionId:()=>I,getSnippets:()=>m,getToken:()=>u,removeSnippet:()=>Q,resetSession:()=>At,saveSnippets:()=>N,setToken:()=>Bt});function u(){return localStorage.getItem(_e)||null}function Bt(e){localStorage.setItem(_e,e)}function I(){let e=localStorage.getItem(V);return e||(e=crypto.randomUUID(),localStorage.setItem(V,e)),e}function At(){localStorage.removeItem(V),localStorage.removeItem(H)}function m(){try{return JSON.parse(localStorage.getItem(H)||"[]")}catch{return[]}}function N(e){localStorage.setItem(H,JSON.stringify(e))}function G(e){let t=m(),n=t.length>0?Math.max(...t.map(r=>r.number||0))+1:1,o={...e,number:n,created_at:Date.now()};return t.push(o),N(t),o}function Q(e){let t=m().filter(n=>n.number!==e);N(t)}function M(){localStorage.removeItem(H)}var H,V,_e,f=v(()=>{"use strict";H="nexus_scraper_snippets",V="nexus_scraper_session",_e="nexus_auth_token"});var ke,Ie=v(()=>{ke=`
...
`),document.head.appendChild(e)}var Ue=v(()=>{Ie();Te();Be();Ce();Ne();je();Pe();Re()});function Ye(){De();let e=document.createElement("div");e.id=qe,e.innerHTML='\u{1F577}\uFE0F<span class="vn-fab-dot"></span>';let t=document.createElement("div");return t.id=te,t.innerHTML=`
  ...
  `,e.onclick=Ct,document.body.appendChild(e),document.body.appendChild(t),{fab:e,panel:t}}function Ct(){ee=!ee;let e=document.getElementById(te);e&&e.classList.toggle("vn-open",ee)}function ne(){return document.getElementById(qe)}function B(){return document.getElementById(te)}function y(e){let t=document.getElementById("vn-warn-banner"),n=document.getElementById("vn-warn-text");!t||!n||(n.textContent=e,t.classList.add("vn-show"),clearTimeout(t._timer),t._timer=setTimeout(()=>t.classList.remove("vn-show"),5e3))}function w(e,t,n){let o=document.getElementById(`vn-badge-${e}`),r=document.getElementById(`vn-badge-${e}-text`);!o||!r||(o.className="vn-badge-pill"+(n?" "+n:""),r.textContent=t)}var qe,te,ee,L=v(()=>{Ue();qe="__venom_fab__",te="__venom_panel__",ee=!1});var Fe={};z(Fe,{initTabs:()=>oe,restoreLastTab:()=>se,switchTab:()=>re});function oe(){let e=document.getElementById("__venom_panel__");if(!e)return;e.querySelectorAll(".vn-tab").forEach(n=>{n.onclick=()=>{let o=n.dataset.tab;re(o)}})}function re(e){if(!Xe.includes(e))return;let t=document.getElementById("__venom_panel__");if(!t)return;t.querySelectorAll(".vn-tab").forEach(o=>{o.classList.toggle("vn-active",o.dataset.tab===e)}),t.querySelectorAll(".vn-tab-content").forEach(o=>{o.classList.remove("vn-active")});let n=document.getElementById(`vn-tab-${e}`);n&&n.classList.add("vn-active"),localStorage.setItem("vn_last_tab",e)}function se(){let e=localStorage.getItem("vn_last_tab");e&&Xe.includes(e)&&re(e)}var Xe,ie=v(()=>{Xe=["agent","snippets","settings"]});var We={};z(We,{readPage:()=>j});function j(){return{url:location.href,title:document.title||"",content:zt()}}function zt(){let e=document.createTreeWalker(document.body,NodeFilter.SHOW_TEXT,{acceptNode(o){let r=o.parentElement?.tagName?.toLowerCase();return["script","style","noscript","svg"].includes(r)?NodeFilter.FILTER_REJECT:NodeFilter.FILTER_ACCEPT}}),t=[],n;for(;n=e.nextNode();){let o=n.textContent.trim();o.length>0&&t.push(o)}return t.join(" ").replace(/\s+/g," ").slice(0,5e3)}var D=v(()=>{});function d(e,t){let n=document.getElementById("__venom_fab__");if(!n)return;let o=n.querySelector(".vn-fab-dot");o&&(o.className="vn-fab-dot",e==="green"?o.classList.add("vn-green"):e==="amber"?o.classList.add("vn-amber"):e==="red"&&o.classList.add("vn-red"),n.setAttribute("data-status",t||""))}function Ve(){u()?w("auth","authed","active"):w("auth","unauthed","err")}var U=v(()=>{L();f()});function Qe(e){document.addEventListener("selectionchange",()=>{clearTimeout(Ge),Ge=setTimeout(()=>{let t=q();t&&e(t)},300)}),document.addEventListener("touchend",()=>{setTimeout(()=>{let t=q();t&&e(t)},50)})}function q(){let e=window.getSelection();if(!e||e.rangeCount===0)return"";let t=e.toString().trim();return t.length>0?t.slice(0,2e3):""}var Ge,le=v(()=>{Ge=null});var ot={};z(ot,{pollSettings:()=>ce,syncToBackend:()=>de});function nt(e){return!e||typeof e!="string"?!1:e.trimStart().startsWith("data:")}function Jt(e){let t=typeof e.text=="string"?e.text:"";return nt(t)?(console.warn("[VENOM sync] base64 detected in snippet text \u2014 stripped before sync",{number:e.number,type:e.type}),e.type==="image"&&typeof e.url=="string"?e.url.slice(0,tt):""):t.slice(0,Kt)}function Zt(e){let t={number:e.number,text:Jt(e),type:e.type||"research",url:typeof e.url=="string"?e.url.slice(0,tt):typeof window<"u"?window.location.href:"",title:typeof e.title=="string"?e.title.slice(0,200):typeof document<"u"?document.title.slice(0,200):""};if(e.type==="image"&&(e.mime_type&&typeof e.mime_type=="string"&&(t.mime_type=e.mime_type),typeof e.file_size=="number"&&(t.file_size=e.file_size),e.metadata&&typeof e.metadata=="object")){let n={...e.metadata};(n.base64||nt(n.data||""))&&(delete n.base64,delete n.data),t.metadata=n}return e.type==="file"&&(typeof e.file_size=="number"&&(t.file_size=e.file_size),e.metadata&&typeof e.metadata=="object"&&(t.metadata={...e.metadata})),t}async function de(e){let t=u(),n=m();if(!t)return e("error","Login to dashboard first"),!1;if(!n||n.length===0)return e("error","No snippets staged"),!1;let r=n.map(Zt).filter(s=>!(!s.text&&s.type!=="image"||s.type==="image"&&!s.text&&!s.url));if(r.length===0)return e("error","No valid snippets to sync after sanitisation"),!1;e("syncing",`Syncing ${r.length} snippet${r.length!==1?"s":""}...`);try{let s=await fetch(`${et}/api/scraper-agent`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`},body:JSON.stringify({sessionId:I(),snippets:r,pageContext:j()}),signal:AbortSignal.timeout(Ft)}),i=await s.json();if(!s.ok)return e("error",i.message||`Sync failed (${s.status})`),!1;M();let a=i.saved||0;return e("success",`\u2713 ${a} snippet${a!==1?"s":""} synced`),!0}catch(s){return s.name==="TimeoutError"||s.name==="AbortError"?e("error","Sync timed out \u2014 check connection"):e("error","Backend unreachable \u2014 snippets buffered locally"),!1}}async function ce(e){if(!e)return null;try{let t=await fetch(`${et}/api/sync`,{headers:{Authorization:`Bearer ${e}`},signal:AbortSignal.timeout(Wt)});return t.ok&&(await t.json()).settings||null}catch{return null}}var et,Ft,Wt,Kt,tt,Y=v(()=>{f();D();et="https://vinnsedesigner-vinns-ai-backend.hf.space",Ft=3e4,Wt=1e4,Kt=2e3,tt=2048});var ge={};z(ge,{buildSnippetsTab:()=>ue,renderSnippets:()=>h,showSelectionOverlay:()=>me});function c(e){return(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}function F(e){return!e||typeof e!="number"?"":e<1024?`${e}B`:e<1024*1024?`${(e/1024).toFixed(1)}KB`:`${(e/1024/1024).toFixed(1)}MB`}function at(e){return{js:"\u{1F7E8}",ts:"\u{1F537}",jsx:"\u{1F7E6}",tsx:"\u{1F537}",py:"\u{1F40D}",json:"\u{1F4CB}",md:"\u{1F4DD}",txt:"\u{1F4C4}",css:"\u{1F3A8}",html:"\u{1F310}",sql:"\u{1F5C4}\uFE0F",yaml:"\u2699\uFE0F",yml:"\u2699\uFE0F",sh:"\u26A1",rs:"\u{1F980}",go:"\u{1F439}",rb:"\u{1F48E}",java:"\u2615"}[(e||"").toLowerCase()]||"\u{1F4C1}"}function Gt(e){return typeof e=="string"&&e.trimStart().startsWith("data:")}function pe(e){let t=e.text||e.url||"";return!t||Gt(t)?null:t}function ue(){let e=document.getElementById("vn-tab-snippets");e&&(e.innerHTML=`
  ...
  `,document.body.appendChild(g),g.querySelector("#vn-sel-repo").addEventListener("click",()=>rt("code")),g.querySelector("#vn-sel-research").addEventListener("click",()=>rt("research")),document.addEventListener("click",e=>{g.contains(e.target)||ve()}))}function me(e){!g||!e||setTimeout(()=>{let t=window.getSelection();if(!t||t.rangeCount===0)return;let n=t.getRangeAt(0).getBoundingClientRect();g.style.top=`${n.bottom+8}px`,g.style.left=`${Math.max(0,n.left)}px`,g.classList.add("vn-show")},300)}function ve(){g?.classList.remove("vn-show")}function rt(e){let t=q();if(!t)return;let n=m(),o=parseInt(localStorage.getItem("vn_snippet_limit")||"20",10);if(n.length>=o){d("red",`Max ${o} snippets`),y(`Snippet limit (${o}) reached \u2014 sync or clear first`),ve();return}G({text:t,type:e,url:location.href,title:document.title}),h(),ve(),d("green",`#${n.length+1} staged`)}function st(e){let t=document.getElementById("vn-view-modal"),n=document.getElementById("vn-modal-title"),o=document.getElementById("vn-modal-body");if(!(!t||!o||!n)){if(n.textContent=`#${e.number} \xB7 ${e.type}`+(e.title?` \xB7 ${e.title.slice(0,30)}`:""),e.type==="image"){let r=pe(e),s=A.get(e.number),i=F(e.file_size),a=e.mime_type||"";o.innerHTML=`
    ...
    `,s||o.querySelector(`#vn-analyze-modal-${e.number}`)?.addEventListener("click",()=>lt(e,o))}else if(e.type==="file"){let r=e.metadata?.extension||"",s=F(e.file_size),i=at(r);o.innerHTML=`
    ...
    `;t.classList.add("vn-show")}}function it(){document.getElementById("vn-view-modal")?.classList.remove("vn-show")}async function lt(e,t){let n=u();if(!n){y("Login to dashboard first");return}let o=`vn-analyze-modal-${e.number}`,r=`vn-analyze-result-${e.number}`,s=t.querySelector(`#${o}`),i=t.querySelector(`#${r}`);s&&(s.textContent="\u23F3 Analyzing...",s.disabled=!0),i&&(i.textContent=""),d("amber","analyzing image...");try{let a=pe(e),l=a?{imageUrl:a,mimeType:e.mime_type||"image/jpeg",question:"Describe this image in detail."}:null;if(!l)throw new Error("No valid image URL for analysis");let b=await fetch(`${Vt}/api/vision`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${n}`},body:JSON.stringify(l),signal:AbortSignal.timeout(3e4)}),$=await b.json();if(!b.ok)throw new Error($.message||`Vision API error (${b.status})`);let P=$.analysis||"No analysis returned";A.set(e.number,P),i&&(i.innerHTML=`
      ...
      `),s&&(s.style.display="none"),d("green","analysis complete")}catch(a){let l=a.name==="TimeoutError"||a.name==="AbortError"?"Analysis timed out \u2014 try again":a.message||"Analysis failed";i&&(i.textContent=`\u26A0 ${l}`),s&&(s.textContent="\u{1F50D} Retry Analysis",s.disabled=!1),d("red","analysis failed"),y(l)}}function tn(e){let n=m().find(r=>r.number===e);if(!n)return;Q(e),h(),A.delete(e);let o={snippet:n,timer:null};E.push(o),dt(`Snippet #${e} removed`),o.timer=setTimeout(()=>{E=E.filter(r=>r.snippet.number!==e),E.length===0&&ct()},5e3)}function nn(){let e=E.pop();if(!e)return;clearTimeout(e.timer);let t=m();t.push(e.snippet),t.sort((n,o)=>n.number-o.number),N(t),h(),E.length===0?ct():dt(`Snippet #${E[E.length-1].snippet.number} removed`)}function dt(e){let t=document.getElementById("vn-undo-bar"),n=document.getElementById("vn-undo-text");t&&n&&(n.textContent=e,t.classList.add("vn-show"))}function ct(){document.getElementById("vn-undo-bar")?.classList.remove("vn-show")}function h(){let e=m(),t=e.filter(i=>i.type==="code"),n=e.filter(i=>i.type==="research"),o=e.filter(i=>i.type==="image"),r=e.filter(i=>i.type==="file"),s=(i,a)=>{let l=document.getElementById(i);l&&(l.textContent=a)};s("vn-repo-count",t.length),s("vn-research-count",n.length),s("vn-image-count",o.length),s("vn-file-count",r.length),w("snip",`${e.length} snippets`,e.length>0?"active":""),X("vn-repo-list",t,rn),X("vn-research-list",n,sn),X("vn-image-list",o,an),X("vn-file-list",r,ln),on(e)}function X(e,t,n){let o=document.getElementById(e);if(o){if(t.length===0){o.innerHTML='<div class="vn-snip-empty">\u2014</div>';return}o.innerHTML=t.map(n).join("")}}function on(e){document.querySelectorAll(".vn-snip-view").forEach(t=>{t.addEventListener("click",()=>{let n=e.find(o=>o.number===Number(t.dataset.num));n&&st(n)})}),document.querySelectorAll(".vn-snip-del").forEach(t=>{t.addEventListener("click",()=>{tn(Number(t.dataset.num))})}),document.querySelectorAll(".vn-snip-analyze").forEach(t=>{t.addEventListener("click",async()=>{let n=e.find(r=>r.number===Number(t.dataset.num));if(!n)return;st(n);let o=document.getElementById("vn-modal-body");o&&!A.has(n.number)&&await lt(n,o)})})}function rn(e){return`
  ...
  `}function an(e){let t=pe(e),n=F(e.file_size);return`
  ...
  `}function ln(e){let t=e.metadata?.extension||"",n=F(e.file_size),o=at(t),r=(e.text||e.url||"").slice(0,40);return`
    <div class="vn-snip-item">
  ...
  `}var Vt,g,E,A,C=v(()=>{f();le();Y();U();L();Vt="https://vinnsedesigner-vinns-ai-backend.hf.space",g=null,E=[],A=new Map});f();L();ie();f();D();var Ke="https://vinnsedesigner-vinns-ai-backend.hf.space",Nt=10,Mt=2e3,jt=2048,Ot=3e4,Pt=6e4,Ht=20;function Rt(e){return!e||typeof e!="string"?!1:e.trimStart().startsWith("data:")}function Dt(e){let t=typeof e.text=="string"?e.text:"";return Rt(t)?(console.warn("[VENOM mini-agent] base64 stripped from snippet before send",{type:e.type}),e.type==="image"&&typeof e.url=="string"?e.url.slice(0,jt):""):t.slice(0,Mt)}function Ut(e){if(!e||typeof e!="object"||!new Set(["code","research","image","file"]).has(e.type))return null;let n=Dt(e);return!n&&e.type!=="image"||!n&&e.type==="image"&&!e.url?null:{type:e.type,text:n||e.url||""}}function Je(e){return!Array.isArray(e)||e.length===0?[]:e.slice(0,Ht).map(Ut).filter(Boolean)}function Ze(e){if(!Array.isArray(e)||e.length===0)return[];let t=new Set(["user","assistant","system"]);return e.filter(n=>n&&t.has(n.role)&&n.content).slice(-Nt).map(n=>({role:n.role,content:String(n.content).slice(0,1e3)}))}function qt(){return u()||null}function Yt(){try{return j()}catch(e){return console.warn("[VENOM mini-agent] buildPageContext failed",e.message),{url:typeof window<"u"?window.location.href:"",title:typeof document<"u"?document.title:"",content:""}}}async function Xt(e,t,n,o,r,s){try{let i=await fetch(`${Ke}/api/agent`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${o}`},body:JSON.stringify({message:e,pageContext:n,history:Ze(r),snippets:Je(t),sessionId:s||null,context:"bookmarklet",stream:!1}),signal:AbortSignal.timeout(Pt)}),a=await i.json();return i.ok?{reply:a.reply||a.response||"",model:a.model_used||a.model||"agent",escalated:!0,tools_used:a.tools_used||[],searched:!1}:{error:a.message||`Full agent error (${i.status})`,escalated:!0}}catch(i){return{error:i.name==="TimeoutError"||i.name==="AbortError"?"Full agent timed out \u2014 try again":"Full agent unreachable",escalated:!0}}}async function ae(e,t=[],n=[],o={}){let{sessionId:r=null,preferredModel:s=null}=o,i=qt();if(!i)return{error:"Not authenticated \u2014 open dashboard and login first"};if(!e||typeof e!="string"||!e.trim())return{error:"Message is required"};let a=e.trim(),l=Yt(),b=Je(t),$=Ze(n),P={message:a,pageContext:l,history:$,snippets:b,sessionId:r||null,preferredModel:s||null},S,k;try{k=await fetch(`${Ke}/api/lite-agent`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${i}`},body:JSON.stringify(P),signal:AbortSignal.timeout(Ot)}),S=await k.json()}catch(Ee){return{error:Ee.name==="TimeoutError"||Ee.name==="AbortError"?"Lite agent timed out \u2014 check connection":"Backend unreachable \u2014 check connection"}}return k.ok?S.escalate===!0?Xt(a,t,l,i,n,r):{reply:S.reply||"",model:S.model||"lite",escalated:!1,tools_used:S.tools_used||[],searched:S.searched||!1}:k.status===503?{error:"All AI providers are currently unavailable \u2014 try again shortly"}:k.status===429?{error:S.message||"Rate limit reached \u2014 try again in a few minutes"}:k.status===401?{error:"Session expired \u2014 open dashboard and login again"}:{error:S.message||`Request failed (${k.status})`}}f();U();L();var x=[],W=null,T=I(),_=null,K="vn_chat_sessions",be={model:{args:!0,hint:"/model <name|reset|?>"},clear:{args:!1,hint:"/clear"},page:{args:!1,hint:"/page"},images:{args:!1,hint:"/images"},sync:{args:!1,hint:"/sync"},snippets:{args:!1,hint:"/snippets"},help:{args:!1,hint:"/help"}},fe=["groq","llama","devstral","mistral","gemini","gemini-lite","gemma-26","gemma-31","reset"];function ut(){let e=document.getElementById("vn-tab-agent");e&&(e.innerHTML=`
  ...
  `,dn(),gt(),he())}function dn(){document.getElementById("vn-send-btn")?.addEventListener("click",pt),document.getElementById("vn-suggest-btn")?.addEventListener("click",pn),document.getElementById("vn-inject-btn")?.addEventListener("click",wn),document.getElementById("vn-inject-dismiss")?.addEventListener("click",mt),document.getElementById("vn-hamburger")?.addEventListener("click",En),document.getElementById("vn-drawer-close")?.addEventListener("click",xe),document.getElementById("vn-new-chat")?.addEventListener("click",_n);let e=document.getElementById("vn-agent-input");e?.addEventListener("keydown",t=>{t.key==="Enter"&&!t.shiftKey&&(t.preventDefault(),pt()),t.key==="Escape"&&O()}),e?.addEventListener("input",()=>{let t=e.value;t.startsWith("/")?cn(t):O()})}function cn(e){let t=document.getElementById("vn-slash-popup"),n=document.getElementById("vn-slash-list");if(!t||!n)return;let o=e.slice(1).toLowerCase().split(" ")[0],r=Object.keys(be).filter(s=>s.startsWith(o));if(r.length===0){O();return}n.innerHTML=r.map(s=>`
    <div class="vn-slash-item" data-cmd="/${s}">
      <span class="vn-slash-cmd">${be[s].hint}</span>
    </div>
  `).join(""),n.querySelectorAll(".vn-slash-item").forEach(s=>{s.addEventListener("click",()=>{let i=document.getElementById("vn-agent-input");i&&(i.value=s.dataset.cmd+" "),O(),i?.focus()})}),t.style.display="block"}function O(){let e=document.getElementById("vn-slash-popup");e&&(e.style.display="none")}function vn(e){let t=e.trim().split(/\s+/),n=t[0].slice(1).toLowerCase(),o=t.slice(1).join(" ").trim();switch(n){case"model":return!o||o==="?"?(p("agent",`\u{1F4CD} Current model: **${_||"auto (modelRouter)"}**
Available: ${fe.join(", ")}`),!0):o==="reset"?(_=null,vt(),p("agent","\u{1F504} Model reset to auto \u2014 modelRouter decides"),!0):fe.includes(o.toLowerCase())?(_=o.toLowerCase(),vt(),p("agent",`\u{1F4CC} Model pinned to **${_}** for this session`),!0):(p("agent",`\u2753 Unknown model "${o}". Valid: ${fe.join(", ")}`),!0);case"clear":{x=[];let r=document.getElementById("vn-convo");return r&&(r.innerHTML=`
        <div class="vn-msg vn-msg-agent">
          <div class="vn-msg-label">NExY</div>
          <span>Cleared \u{1F9F9} fresh session</span>
        </div>`),!0}case"page":return Promise.resolve().then(()=>(D(),We)).then(({readPage:r})=>{let s=r();Promise.resolve().then(()=>(f(),R)).then(({addSnippet:i})=>{i({text:s.content,type:"research",url:s.url,title:s.title}),Promise.resolve().then(()=>(C(),ge)).then(({renderSnippets:a})=>a()),p("agent",`\u{1F4C4} Page captured as research snippet \u2014 ${s.content.length} chars`)})}).catch(()=>p("agent","\u26A0 Could not capture page")),!0;case"images":{let r=Array.from(document.images).filter(s=>s.naturalWidth>100&&s.src&&!s.src.startsWith("data:")).slice(0,10);return r.length===0?(p("agent","\u{1F5BC}\uFE0F No suitable images found on this page"),!0):(Promise.resolve().then(()=>(f(),R)).then(({addSnippet:s})=>{r.forEach(i=>{s({text:i.src,type:"image",url:i.src,title:i.alt||"image"})}),Promise.resolve().then(()=>(C(),ge)).then(({renderSnippets:i})=>i()),p("agent",`\u{1F5BC}\uFE0F Captured ${r.length} image${r.length!==1?"s":""} as snippets`)}),!0)}case"sync":return Promise.resolve().then(()=>(Y(),ot)).then(({syncToBackend:r})=>{r((s,i)=>{d(s==="success"?"green":s==="error"?"red":"amber",i)})}),p("agent","\u21C5 Syncing snippets to backend..."),!0;case"snippets":return Promise.resolve().then(()=>(ie(),Fe)).then(({switchTab:r})=>r("snippets")),!0;case"help":{let r=Object.values(be).map(s=>s.hint).join(`
`);return p("agent",`**Slash commands:**
${r}`),!0}default:return!1}}function vt(){let e=document.getElementById("vn-model-pill");e&&(_?(e.textContent=`\u{1F4CC} ${_}`,e.style.display="inline-block"):e.style.display="none")}function he(){let e=document.getElementById("vn-session-label");e&&(e.textContent=T.slice(0,8).toUpperCase())}async function pt(){let e=document.getElementById("vn-agent-input"),t=e?.value?.trim();if(!t)return;if(O(),t.startsWith("/")&&vn(t)){e.value="";return}let n=x.slice();x.push({role:"user",content:t}),p("user",t),e.value="",d("amber","thinking..."),w("model","thinking...","warn");let o=await ae(t,m(),n,{sessionId:String(T),preferredModel:_||null}),{reply:r,model:s,escalated:i,error:a,tools_used:l}=o;if(a){p("agent",`\u26A0 ${a}`),d("red","error"),y(a),w("model","error","err"),x.push({role:"assistant",content:`\u26A0 ${a}`});return}x.push({role:"assistant",content:r});let b=l&&l.length>0?`${s||"lite"} \xB7 \u{1F527}${l.join(",")}`:s||"lite";p("agent",r,b),d("green",i?"done (escalated)":"done"),w("model",s||"lite","active"),kn(x)}async function pn(){let e="Based on this page, suggest a concise prompt I can send to my AI assistant. Reply with only the suggested prompt, nothing else.";d("amber","generating...");let t=await ae(e,m(),x,{sessionId:String(T),preferredModel:_||null}),{reply:n,error:o}=t;if(o||!n){d("red","suggestion failed"),y("Suggestion failed: "+(o||"empty reply"));return}W=n,yn(n),d("green","ready to inject")}function p(e,t,n){let o=document.getElementById("vn-convo");if(!o)return;let r=document.createElement("div");r.className=`vn-msg vn-msg-${e}`;let s=document.createElement("div");s.className="vn-msg-label",s.textContent=e==="user"?"YOU":n?`NExY \xB7 ${n}`:"NExY",r.appendChild(s),un(t).forEach(i=>r.appendChild(i)),o.appendChild(r),o.scrollTop=o.scrollHeight}function un(e){let t=[];return e.split(/(```[\s\S]*?```)/g).forEach(o=>{if(o.startsWith("```")){let r=o.slice(3,-3),s=r.indexOf(`
`),i=s>=0?r.slice(0,s).trim():"",a=s>=0?r.slice(s+1).trim():r.trim();t.push(mn(i,a))}else if(hn(o)){let r=document.createElement("pre");r.className="vn-ascii-block",r.textContent=xn(o.trim()),t.push(r)}else if(o.trim()){let r=document.createElement("span");r.textContent=o,r.style.whiteSpace="pre-wrap",t.push(r)}}),t}function mn(e,t){let n=bn(e,t),o=document.createElement("div");o.className="vn-code-block";let r=gn(t,n);return o.innerHTML=`
    <div class="vn-code-header">
      <span class="vn-code-lang">#${n}</span>
      <button class="vn-code-copy">copy</button>
    </div>
    <div class="vn-code-body">${r}</div>
  `,o.querySelector(".vn-code-copy").onclick=()=>{navigator.clipboard?.writeText(t).catch(()=>{});let s=o.querySelector(".vn-code-copy");s.textContent="copied!",setTimeout(()=>{s&&(s.textContent="copy")},1500)},o}function gn(e,t){let n=ft(e);return fn(t).forEach(([r,s])=>{n=n.replace(r,i=>`<span class="sh-${s}">${i}</span>`)}),n}function fn(e){let t=[/(&quot;|&#x27;)(.*?)(\1)/g,"str"],n=[/\/\/[^\n]*/g,"cmt"],o=[/#[^\n]*/g,"cmt"],r=[/\b(\d+\.?\d*)\b/g,"num"],s=[/\b(true|false|null|undefined|None|True|False)\b/g,"kw2"];return["js","ts","jsx","tsx"].includes(e)?[n,t,[/\b(const|let|var|function|return|if|else|for|while|class|import|export|from|async|await|new|typeof|instanceof|this|super|throw|try|catch|finally|of|in|switch|case|break|continue|default)\b/g,"kw"],s,r,[/\b([A-Z][a-zA-Z0-9_]*)\b/g,"cls"],[/\b([a-zA-Z_$][a-zA-Z0-9_$]*)\s*(?=\()/g,"fn"]]:["py","python"].includes(e)?[o,t,[/\b(def|class|import|from|return|if|elif|else|for|while|in|not|and|or|is|with|as|try|except|finally|raise|lambda|pass|break|continue|yield|global|nonlocal)\b/g,"kw"],s,r,[/\b([A-Z][a-zA-Z0-9_]*)\b/g,"cls"],[/\b([a-z_][a-zA-Z0-9_]*)\s*(?=\()/g,"fn"]]:["sh","bash","shell","zsh"].includes(e)?[o,t,[/\b(if|then|else|elif|fi|for|do|done|while|case|esac|function|return|export|source|echo|cd|ls|mkdir|rm|cp|mv|cat|grep|awk|sed|curl|git|npm|node)\b/g,"kw"],[/\$[a-zA-Z_][a-zA-Z0-9_]*/g,"var"],r]:e==="json"?[t,[/\b(true|false|null)\b/g,"kw2"],r]:e==="css"?[[/\/\*[\s\S]*?\*\//g,"cmt"],t,[/([a-zA-Z-]+)\s*:/g,"kw"],r]:e==="html"?[[/&lt;!--[\s\S]*?--&gt;/g,"cmt"],[/&lt;\/?([a-zA-Z][a-zA-Z0-9-]*)/g,"kw"],t]:[t,r,s]}function bn(e,t){let n=(e||"").toLowerCase().trim(),o={js:"js",javascript:"js",jsx:"jsx",ts:"ts",typescript:"ts",tsx:"tsx",py:"py",python:"py",sh:"sh",bash:"sh",shell:"sh",zsh:"sh",json:"json",css:"css",html:"html"};return o[n]?o[n]:/^\s*\{[\s\S]*\}\s*$/.test(t)&&/"[^"]+"\s*:/.test(t)?"json":/(def |import |from .* import|print\(|elif |:\s*$)/m.test(t)?"py":/(const |let |var |function |=>|require\(|module\.exports)/m.test(t)?"js":/(#!\/bin\/(bash|sh)|echo |grep |awk |npm |git )/m.test(t)?"sh":n||"code"}function hn(e){let t=/[├└│─┤┬┴┼]/;return e.trim().split(`
`).filter(n=>t.test(n)).length>=2}function xn(e){return e.replace(/\|--/g,"\u251C\u2500\u2500 ").replace(/\+--/g,"\u251C\u2500\u2500 ").replace(/`--/g,"\u2514\u2500\u2500 ").replace(/\|  /g,"\u2502   ")}function yn(e){let t=document.getElementById("vn-inject-banner"),n=document.getElementById("vn-inject-text");t&&n&&(n.textContent=e.slice(0,180),t.classList.add("vn-show"))}function mt(){document.getElementById("vn-inject-banner")?.classList.remove("vn-show"),W=null}function wn(){let e=W||document.getElementById("vn-inject-text")?.textContent;if(!e)return;let t=Sn(e);mt(),W=null,t===!1?(d("red","no input found"),y("No writable input found on this page")):d("green",t==="clipboard"?"copied to clipboard":"injected \u2197")}function Sn(e){if(!e||typeof e!="string")return!1;let t=["textarea:not([disabled]):not([readonly])",'div[contenteditable="true"]','input[type="text"]:not([disabled])','[role="textbox"]'];for(let n of t){let o=document.querySelector(n);if(o)try{if(o.tagName==="TEXTAREA"||o.tagName==="INPUT")return o.focus(),o.value=e,o.dispatchEvent(new Event("input",{bubbles:!0})),o.dispatchEvent(new Event("change",{bubbles:!0})),!0;if(o.contentEditable==="true")return o.focus(),document.execCommand("selectAll",!1,null),document.execCommand("insertText",!1,e),!0}catch{continue}}try{return navigator.clipboard.writeText(e),"clipboard"}catch{return!1}}function En(){document.getElementById("vn-history-drawer")?.classList.add("vn-open"),gt()}function xe(){document.getElementById("vn-history-drawer")?.classList.remove("vn-open")}function _n(){x=[],Promise.resolve().then(()=>(f(),R)).then(({resetSession:t,getSessionId:n})=>{t(),T=n(),he()});let e=document.getElementById("vn-convo");e&&(e.innerHTML=`
    <div class="vn-msg vn-msg-agent">
      <div class="vn-msg-label">NExY</div>
      <span>Ask me anything about this page...</span>
    </div>`),xe()}function kn(e){if(!(!e||e.length===0))try{let t=JSON.parse(localStorage.getItem(K)||"[]"),n=t.findIndex(s=>s.id===T),o=e.find(s=>s.role==="user")?.content?.slice(0,60)||"Chat",r={id:T,ts:new Date().toLocaleTimeString(),preview:o,messages:e.slice()};n>=0?t[n]=r:t.unshift(r),localStorage.setItem(K,JSON.stringify(t.slice(0,20)))}catch{}}function gt(){let e=document.getElementById("vn-history-list");if(e)try{let t=JSON.parse(localStorage.getItem(K)||"[]");if(t.length===0){e.innerHTML='<div class="vn-history-empty">No sessions yet</div>';return}e.innerHTML=t.map(n=>`
    ...
    `).join(""),e.querySelectorAll(".vn-history-item").forEach(n=>{n.onclick=()=>In(n.dataset.id)})}catch{}}function In(e){try{let n=JSON.parse(localStorage.getItem(K)||"[]").find(r=>r.id===e);if(!n)return;x=n.messages.slice(),T=n.id,he();let o=document.getElementById("vn-convo");if(!o)return;o.innerHTML="",x.forEach(r=>p(r.role==="user"?"user":"agent",r.content)),xe()}catch{}}function ft(e){return(e||"").replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#x27;")}C();L();f();C();function ht(){let e=document.getElementById("vn-tab-settings");if(!e)return;let t=parseInt(localStorage.getItem("vn_panel_height")||"55"),n=localStorage.getItem("vn_theme")||"oled",o=parseInt(localStorage.getItem("vn_snippet_limit")||"20");e.innerHTML=`
  ...
  `,Ln()}function Ln(){let e=document.getElementById("vn-height-slider"),t=document.getElementById("vn-height-val"),n=document.getElementById("vn-theme-oled"),o=document.getElementById("vn-theme-light"),r=document.getElementById("vn-snippet-limit"),s=document.getElementById("vn-clear-snippets");e?.addEventListener("input",()=>{let i=e.value;t.textContent=`${i}vh`;let a=B();a&&(a.style.height=`${i}vh`),localStorage.setItem("vn_panel_height",i)}),n?.addEventListener("click",()=>{bt("oled"),n.classList.add("vn-selected"),o?.classList.remove("vn-selected")}),o?.addEventListener("click",()=>{bt("light"),o.classList.add("vn-selected"),n?.classList.remove("vn-selected")}),r?.addEventListener("change",()=>{let i=Math.max(1,Math.min(100,parseInt(r.value)||20));localStorage.setItem("vn_snippet_limit",i),r.value=i}),s?.addEventListener("click",()=>{confirm("Clear all snippets?")&&(M(),h())})}function bt(e){let t=B();t&&(t.classList.remove("vn-theme-oled","vn-theme-light"),e!=="oled"&&t.classList.add(`vn-theme-${e}`),localStorage.setItem("vn_theme",e))}L();var J=!1,xt,yt,ye,we,Z=!1,wt,St;function Et(){Tn(),$n()}function Tn(){let e=ne();if(!e)return;function t(r,s){J=!0,xt=r,yt=s;let i=e.getBoundingClientRect();ye=i.left,we=i.top,e.style.right="auto",e.style.bottom="auto",e.style.left=ye+"px",e.style.top=we+"px",e.style.transition="none",e.classList.add("vn-dragging")}function n(r,s){if(!J)return;let i=r-xt,a=s-yt,l=Math.max(0,Math.min(window.innerWidth-56,ye+i)),b=Math.max(0,Math.min(window.innerHeight-56,we+a));e.style.left=l+"px",e.style.top=b+"px",localStorage.setItem("vn_fab_left",l),localStorage.setItem("vn_fab_top",b)}function o(){J=!1,e.classList.remove("vn-dragging")}e.addEventListener("mousedown",r=>{r.target!==e&&!r.target.classList.contains("vn-fab-dot")||(r.preventDefault(),r.stopPropagation(),t(r.clientX,r.clientY))}),document.addEventListener("mousemove",r=>n(r.clientX,r.clientY)),document.addEventListener("mouseup",o),e.addEventListener("touchstart",r=>{if(r.target!==e&&!r.target.classList.contains("vn-fab-dot"))return;let s=r.touches[0];t(s.clientX,s.clientY)},{passive:!0}),document.addEventListener("touchmove",r=>{if(!J)return;r.preventDefault();let s=r.touches[0];n(s.clientX,s.clientY)},{passive:!1}),document.addEventListener("touchend",o)}function $n(){let e=document.getElementById("vn-drag-handle"),t=B();if(!e||!t)return;function n(s){Z=!0,wt=s,St=t.offsetHeight}function o(s){if(!Z)return;let i=wt-s,a=Math.max(window.innerHeight*.25,Math.min(window.innerHeight*.85,St+i));t.style.height=a+"px",localStorage.setItem("vn_panel_height",Math.round(a/window.innerHeight*100))}function r(){Z=!1}e.addEventListener("mousedown",s=>{s.preventDefault(),n(s.clientY)}),document.addEventListener("mousemove",s=>o(s.clientY)),document.addEventListener("mouseup",r),e.addEventListener("touchstart",s=>{n(s.touches[0].clientY)},{passive:!0}),document.addEventListener("touchmove",s=>{Z&&(s.preventDefault(),o(s.touches[0].clientY))},{passive:!1}),document.addEventListener("touchend",r)}function _t(){let e=ne();if(!e)return;let t=localStorage.getItem("vn_fab_left"),n=localStorage.getItem("vn_fab_top");t&&n&&(e.style.right="auto",e.style.bottom="auto",e.style.left=t+"px",e.style.top=n+"px")}function kt(){let e=B();if(!e)return;let t=parseInt(localStorage.getItem("vn_panel_height")||"55");e.style.height=`${t}vh`}Y();f();C();var Bn=15e3,Se=null;function It(){Se=setInterval(async()=>{if(!document.getElementById("__venom_panel__")){clearInterval(Se),Se=null;return}let e=u(),t=await ce(e);t&&(t.snippet_limit&&localStorage.setItem("vn_snippet_limit",t.snippet_limit),h())},Bn)}le();U();function Lt(){document.getElementById("__venom_fab__")||(Ye(),oe(),ut(),ue(),ht(),Et(),_t(),kt(),se(),Qe(e=>me(e)),Ve(),It(),d("green","ready"))}function Tt(){let e=u();I(),Lt(),e||console.log("[VENOM Scraper] No auth token \u2014 open dashboard and login first")}(function(){"use strict";if(window.__nexus_scraper_loaded__){document.getElementById("__venom_fab__")?.remove(),document.getElementById("__venom_panel__")?.remove(),document.getElementById("__venom_styles__")?.remove(),window.__nexus_scraper_loaded__=!1;return}window.__nexus_scraper_loaded__=!0,Tt()})();})();
