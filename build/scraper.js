(()=>{var E="nexus_scraper_snippets",T="nexus_scraper_session",G="nexus_auth_token";function u(){return localStorage.getItem(G)||null}function f(){let e=localStorage.getItem(T);return e||(e=crypto.randomUUID(),localStorage.setItem(T,e)),e}function l(){try{return JSON.parse(localStorage.getItem(E)||"[]")}catch{return[]}}function C(e){localStorage.setItem(E,JSON.stringify(e))}function j(e){let t=l(),n=t.length+1,o={...e,number:n,created_at:Date.now()};return t.push(o),C(t),o}function N(e){let t=l().filter(n=>n.number!==e);C(t)}function A(){localStorage.removeItem(E)}var z=null;function L(e){document.addEventListener("selectionchange",()=>{clearTimeout(z),z=setTimeout(()=>{let t=b();t&&e(t)},300)}),document.addEventListener("touchend",()=>{setTimeout(()=>{let t=b();t&&e(t)},50)})}function b(){let e=window.getSelection();if(!e||e.rangeCount===0)return"";let t=e.toString().trim();return t.length>0?t.slice(0,2e3):""}function h(){return{url:location.href,title:document.title||"",content:Q()}}function Q(){let e=document.createTreeWalker(document.body,NodeFilter.SHOW_TEXT,{acceptNode(o){let s=o.parentElement?.tagName?.toLowerCase();return["script","style","noscript","svg"].includes(s)?NodeFilter.FILTER_REJECT:NodeFilter.FILTER_ACCEPT}}),t=[],n;for(;n=e.nextNode();){let o=n.textContent.trim();o.length>0&&t.push(o)}return t.join(" ").replace(/\s+/g," ").slice(0,5e3)}var $="https://vinnsedesigner-vinns-ai-backend.hf.space";async function P(e){let t=u(),n=l();if(!t)return e("error","Login to dashboard first"),!1;if(n.length===0)return e("error","No snippets staged"),!1;e("syncing",`Syncing ${n.length} snippets...`);try{let o=await fetch(`${$}/api/scraper-agent`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${t}`},body:JSON.stringify({sessionId:f(),snippets:n.map(r=>({number:r.number,text:r.text,type:r.type,url:r.url||location.href,title:r.title||document.title})),pageContext:h()})}),s=await o.json();return o.ok?(A(),e("success",`\u2713 ${s.saved} snippets synced`),!0):(e("error",s.message||"Sync failed"),!1)}catch{return e("error","Backend unreachable \u2014 buffered locally"),!1}}async function q(e){if(!e)return null;try{let t=await fetch(`${$}/api/sync`,{headers:{Authorization:`Bearer ${e}`}});return t.ok?(await t.json()).settings:null}catch{return null}}var D="https://vinnsedesigner-vinns-ai-backend.hf.space";async function S(e,t=[]){let n=u();if(!n)return{error:"Not authenticated \u2014 open dashboard and login first"};let o=h(),s={message:e,pageContext:o,snippets:t.map(r=>({type:r.type,text:r.text}))};try{let r=await fetch(`${D}/api/lite-agent`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${n}`},body:JSON.stringify(s)}),a=await r.json();return r.ok?a.escalate===!0?await V(e,t,o,n):{reply:a.reply,model:a.model,escalated:!1}:{error:a.message||"Agent error"}}catch{return{error:"Backend unreachable \u2014 check connection"}}}async function V(e,t,n,o){try{let s=await fetch(`${D}/api/agent`,{method:"POST",headers:{"Content-Type":"application/json",Authorization:`Bearer ${o}`},body:JSON.stringify({message:e,pageContext:n,snippets:t.map(a=>({type:a.type,text:a.text})),stream:!1})}),r=await s.json();return s.ok?{reply:r.response||r.reply||"",model:r.model_used||r.model||"agent",escalated:!0}:{error:r.message||"Full agent error"}}catch{return{error:"Full agent unreachable"}}}function O(e){if(!e||typeof e!="string")return!1;let t=["textarea:not([disabled]):not([readonly])",'div[contenteditable="true"]','input[type="text"]:not([disabled])','[role="textbox"]'];for(let n of t){let o=document.querySelector(n);if(o)try{if(o.tagName==="TEXTAREA"||o.tagName==="INPUT")return o.focus(),o.value=e,o.dispatchEvent(new Event("input",{bubbles:!0})),o.dispatchEvent(new Event("change",{bubbles:!0})),!0;if(o.contentEditable==="true")return o.focus(),document.execCommand("selectAll",!1,null),document.execCommand("insertText",!1,e),!0}catch{continue}}try{return navigator.clipboard.writeText(e),"clipboard"}catch{return!1}}var v="__nexus_hud__",Z=15e3,x=null,y=!1,p={prompt_injection:!0,snippet_limit:20},w=null;function R(){if(document.getElementById(v))return;pe();let e=ee();document.body.appendChild(e),L(t=>ie(t)),de(),m(),ne(e)}function ee(){let e=document.createElement("div");return e.id=v,e.innerHTML=`
  ...
  `,te(e),e}function te(e){e.querySelector("#nx-collapse").onclick=ce,e.querySelector("#nx-close").onclick=le,e.querySelector("#nx-add-code").onclick=()=>M("code"),e.querySelector("#nx-add-research").onclick=()=>M("research"),e.querySelector("#nx-sel-dismiss").onclick=H,e.querySelector("#nx-inject-dismiss").onclick=k,e.querySelector("#nx-inject-btn").onclick=re,e.querySelector("#nx-ask-btn").onclick=F,e.querySelector("#nx-suggest-btn").onclick=oe,e.querySelector("#nx-sync-btn").onclick=se,e.querySelector("#nx-agent-input").addEventListener("keydown",t=>{t.key==="Enter"&&!t.shiftKey&&(t.preventDefault(),F())})}function ne(e){let t=e.querySelector("#nx-hdr"),n=!1,o,s,r,a;function _(i,d){n=!0,o=i,s=d;let g=e.getBoundingClientRect();r=window.innerWidth-g.right,a=window.innerHeight-g.bottom,e.style.transition="none"}function I(i,d){if(!n)return;let g=i-o,K=d-s,Y=Math.max(0,r-g),J=Math.max(0,a+K),U=window.innerWidth-60,W=window.innerHeight-60;e.style.right=Math.min(Y,U)+"px",e.style.bottom=Math.min(J,W)+"px"}function B(){n=!1}t.addEventListener("mousedown",i=>{i.preventDefault(),_(i.clientX,i.clientY)}),document.addEventListener("mousemove",i=>I(i.clientX,i.clientY)),document.addEventListener("mouseup",B),t.addEventListener("touchstart",i=>{let d=i.touches[0];_(d.clientX,d.clientY)},{passive:!0}),document.addEventListener("touchmove",i=>{if(!n)return;i.preventDefault();let d=i.touches[0];I(d.clientX,d.clientY)},{passive:!1}),document.addEventListener("touchend",B)}function M(e){let t=b();if(!t)return;if(l().length>=p.snippet_limit){c("error",`Max ${p.snippet_limit} snippets reached`);return}j({text:t,type:e,url:location.href,title:document.title}),m(),H(),c("ok",`#${l().length} staged`)}async function F(){let t=document.getElementById("nx-agent-input")?.value?.trim();if(!t)return;let n=document.getElementById("nx-reply");n.style.display="none",n.textContent="",c("syncing","asking..."),n.style.display="block",n.textContent="...";let{reply:o,model:s,escalated:r,error:a}=await S(t,l());if(a){n.textContent=`\u26A0 ${a}`,c("error",a);return}n.textContent=o,c("ok",r?"done (full agent)":"done");let _=document.getElementById("nx-model");_&&(_.textContent=s||"groq")}async function oe(){if(!p.prompt_injection){c("error","Prompt injection disabled in settings");return}let e=`Based on this page, suggest a concise prompt I can send to my AI assistant to ${document.title?'understand "'+document.title.slice(0,40)+'"':"get help with this page"}. Reply with only the suggested prompt, nothing else.`;c("syncing","generating...");let{reply:t,error:n}=await S(e,l());if(n||!t){c("error",n||"Suggestion failed");return}w=t,ae(t),c("ok","suggestion ready \u2014 tap inject")}async function se(){await P((e,t)=>{c(e==="success"?"ok":e,t),e==="success"&&m()})}function re(){if(!p.prompt_injection){c("error","Prompt injection disabled in settings"),k();return}let e=w||document.getElementById("nx-inject-text")?.textContent;if(!e)return;let t=O(e);k(),w=null,t===!1?c("error","No input found on page"):c("ok",t==="clipboard"?"copied to clipboard":"injected \u2197")}function m(){let e=l(),t=document.getElementById("nx-snippets-list"),n=document.getElementById("nx-count"),o=document.getElementById("nx-staged");t&&(n.textContent=`${e.length}/${p.snippet_limit}`,o.textContent=`${e.length} staged`,t.innerHTML=e.map(s=>`
